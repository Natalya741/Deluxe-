...
<h5>Проект 1:</h5> Тестирование веб-приложения образовательной платформы английского языка Skyeng личного кабинета учителя (тестовая версия)
Что нужно было сделать:

<ol>
  <li>Cделать тест-план</li>
  <li>Подготовлена ​​тестовая документация</li>
